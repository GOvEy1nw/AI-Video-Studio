    ...
    <div className="h-screen bg-background flex">
      ...
      <aside className="w-64 border-r border-zinc-800 flex flex-col">
        <div className="p-6">
          ...
          <span className="text-white font-bold text-sm ml-2">AiVS</span>
        </div>
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="relative h-72 overflow-hidden">
          ...
          <div className="absolute bottom-6 left-8 z-10">
            <h1 className="text-3xl font-bold text-white mb-2 drop-shadow-lg">AiVS</h1>
            <p className="text-zinc-200 drop-shadow-md">Local-first AI video studio — powered by WanGP</p>
          </div>
        </div>
