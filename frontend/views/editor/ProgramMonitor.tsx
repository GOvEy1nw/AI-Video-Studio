    ...
    >
                ...
                return (
                  <>
                    ...
                    {activeClip?.asset?.type === "image" && (
                      <img
                        ref={
                          previewImageRef as React.RefObject<HTMLImageElement | null>
                        }
                      ...
                      (() => {
                        ...
                        if (incoming.asset?.type === "video") {
                          return (
                            <video
                              ref={
                                previewVideoRef as React.RefObject<HTMLVideoElement | null>
                              }
      ...
      <div className="h-8 bg-surface border-t border-border flex items-center px-3 shrink-0 gap-2">
        ...
        <div className="flex-1 flex items-center justify-center gap-0.5">
          {/* Set In */}
          <Tooltip
            content={`${inPoint !== null ? `In: ${formatTime(inPoint)} — ` : ""}${tooltipLabel("Set In point", getShortcutLabel(kbLayout, "mark.setIn"))}`}
            side="top"
          >
            <Button
              variant="ghost"
          ...
          <Tooltip
            content={tooltipLabel(
              "Go to In Point",
              getShortcutLabel(kbLayout, "transport.goToIn"),
            )}
            side="top"
          >
            <Button
          ...
          <Tooltip
            content={tooltipLabel(
              "Step Back",
              getShortcutLabel(kbLayout, "transport.stepBackward"),
            )}
            side="top"
          >
            <Button
          ...
          <Tooltip
            content={
              isPlaying
                ? tooltipLabel(
                    "Pause",
                    getShortcutLabel(kbLayout, "transport.playPause"),
                  )
                : tooltipLabel(
                    "Play",
                    getShortcutLabel(kbLayout, "transport.playPause"),
          ...
          <Tooltip
            content={tooltipLabel(
              "Step Forward",
              getShortcutLabel(kbLayout, "transport.stepForward"),
            )}
            side="top"
          >
            <Button
          ...
          <Tooltip
            content={tooltipLabel(
              "Go to Out Point",
              getShortcutLabel(kbLayout, "transport.goToOut"),
            )}
            side="top"
          >
            <Button
        ...
        <Tooltip
          content={
            isFullscreen
              ? tooltipLabel(
                  "Exit fullscreen",
                  getShortcutLabel(kbLayout, "view.fullscreen"),
                )
              : tooltipLabel(
                  "Fullscreen",
                  getShortcutLabel(kbLayout, "view.fullscreen"),
