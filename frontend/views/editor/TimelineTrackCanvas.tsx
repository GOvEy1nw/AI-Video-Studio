...
import { ChevronLeft, ChevronRight, Film, GripVertical, Layers, Link2, Loader2, Music, RefreshCw, Trash2, Type, X } from "lucide-react";
...
import { TimelinePlayhead, TimelineSegmentFrame } from "./timeline/TimelinePrimitives";
...
interface TimelineCanvasToolProps {
  ...
  setBladeHoverInfo: React.Dispatch<React.SetStateAction<BladeHoverInfo | null>>;
}
...
interface TimelineCanvasGapProps {
  ...
  setSelectedGapAnchor: React.Dispatch<React.SetStateAction<SelectedGapAnchor | null>>;
...
interface TimelineCanvasDissolveProps {
  ...
  setHoveredCutPoint: React.Dispatch<React.SetStateAction<HoveredCutPoint | null>>;
...
export interface TimelineTrackCanvasProps
  extends TimelineCanvasGeometryProps,
...
export function TimelineTrackCanvas(props: TimelineTrackCanvasProps) {
  const { setSelectedGapAnchor, handleClipContextMenu, currentTime, pixelsPerSecond, trackContainerRef, playheadOverlayRef, activeTool, bladeShiftHeld, SCISSORS_CURSOR, TRACK_FWD_ONE_CURSOR, TRACK_FWD_ALL_CURSOR, handleTimelineScroll, totalDuration, orderedTracks, audioDividerDisplayRow, DIVIDER_H, subtitleTrackHeight, audioTrackHeight, videoTrackHeight, setVideoTrackHeight, setAudioTrackHeight, handleTrackDrop, handleTimelineBgContextMenu, setSelectedSubtitleId, setEditingSubtitleId, setSelectedGap, setGapGenerateMode, clips, setSelectedClipIds, lassoOriginRef, setLassoRect, inPoint, outPoint, lassoRect, assets, getColorLabel, selectedClipIds, draggingClip, slipSlideClip, trackTopPx, getTrackHeight, handleClipMouseDown, expandWithLinkedClips, setShowPropertiesPanel, bladeHoverInfo, setBladeHoverInfo, getClipUrl, getCachedVideoThumbnail, getClipResolution, getLiveAsset, handleClipTakeChange, handleDeleteTake, handleRegenerate, isRegenerating, handleRetakeClip, regenProgress, handleCancelRegeneration, resizingClip, handleResizeStart, timelineGaps, selectedGap, generatingGap, gapRegenProgress, cancelGapGeneration, subtitles, tracks, selectedSubtitleId, editingSubtitleId, addSubtitleClip, updateSubtitle, cutPoints, hoveredCutPoint, setHoveredCutPoint, DEFAULT_DISSOLVE_DURATION, setClips, pushUndo, removeCrossDissolve, addCrossDissolve } = props;
  return (<>
